...
class Pheiphone
{
    ...
    public function find($phone)
    {
        ...
        while ($leftPos < $rightPos - 1) {
            ...
            if ($idx < $telPrefix) {
                ...
                $item = $this->_phoneInfo($itemStr, $type);
                break;
            }
        }
        return $item;
     ...
     * @return array  $data
     */
    private function _phoneInfo($itemStr, $type)
    {
